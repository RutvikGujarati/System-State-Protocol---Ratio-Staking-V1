...
export default function TrackingPage({ children }) {
  ...
  const ToBeClaimed = async () => {
    try {
      ...
      let userDistributedTokens = await burnedAmounts(accountAddress);
      let formattedUserDistributedTokens = ethers.utils.formatEther(
        userDistributedTokens || "0"
      );
      ...
      let formattedTotalToBeClaimed = totalToBeClaimed.toFixed(7);
